...
type LiderNameNodeServiceClient interface {
	GuardarJugada(ctx context.Context, in *JugadaToDataNode, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *liderNameNodeServiceClient) GuardarJugada(ctx context.Context, in *JugadaToDataNode, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type LiderNameNodeServiceServer interface {
	GuardarJugada(context.Context, *JugadaToDataNode) (*Response, error)
...
func (UnimplementedLiderNameNodeServiceServer) GuardarJugada(context.Context, *JugadaToDataNode) (*Response, error) {
...
func _LiderNameNodeService_GuardarJugada_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LiderNameNodeServiceServer).GuardarJugada(ctx, req.(*JugadaToDataNode))
	}
